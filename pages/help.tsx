  ...
  return (
    <Layout>
      ...
      <div className={styles.wrapper}>
        ...
        <p>
          Names and/or NCBI taxonomy identifiers (<span>taxIds</span>) of hosts
          are extracted from nucleotide/protein sequence records of viruses
          available in six source databases:
        ...
        <p>
          ...
          including their names, ranks, and taxIds. Only viruses with
          prokaryotic hosts defined at the species level are included in further
          steps.
        </p>
        <br />
        ...
        <p>
          Host species in NCBI Taxonomy might relate to corresponding GTDB
          species in three ways:
          <ul className={styles.dots}>
            <li>
              one-to-one (one NCBI species corresponds to one GTDB species)
            </li>
            <li>
              many-to-one (multiple NCBI species correspond to one GTDB species)
            </li>
            <li>
              one-to-many (one NCBI species correspond to multiple GTDB species)
            </li>
          </ul>
        </p>
        <p>
          PHD handles only one-to-one and many-to-one relations as NCBI Taxonomy
          is the primary classification used in the PHD database. For
          one-to-many relation, only one GTDB species is selected as the
          corresponding NCBI species. The selection is based on three decision
          criteria including also the majority vote pointed by the Reviewer.
          Specifically, if any of the GTDB species has the same name as NCBI
          species, this one is chosen as the counterpart of NCBI species.
          Otherwise, we select GTDB species with the highest number of genomes.
          If multiple GTDB species have the same number of genomes, we select
          one with the highest assembly quality (based on the assembly level
          reported in GenBank/RefSeq and the CheckM completeness reported in
          GTDB).
        </p>
        <br />

        <h2>
          4. Collect assignments between virus genomic sequences and host
          species
        </h2>
        <p>
          Pairwise linkages between virus genomic sequences and the prokaryotic
          host species are collected from the source databases (i.e., NCBI
          Virus, Virus-Host DB, RefSeq, UniProt, MVP, and IntAct).
        </p>
        <br />

        <h2>
          5. Map virus genomic sequences to virus species based on NCBI Taxonomy
          and ICTV
        </h2>
        <p>
          Virus <span>taxIds</span> provided in GenBank/RefSeq sequence records
          are used to retrieve virus taxonomic lineages from NCBI Taxonomy. The
          obtained virus species <span>taxIds</span> or sequence accessions are
          used to retrieve virus taxonomic lineages (if available) in{" "}
        ...
        <h2>
          6. Assign virus sequences to genome assemblies and select
        ...
        <p>
          Assembly level category (i.e., <i>Complete</i> or <i>Scaffold</i> or{" "}
          <i>Contig</i> or <i>unknown</i>) is assigned to each virus assembly
        ...
        <p>
          A representative genome is selected for each virus species. The
          representative genome has the highest assembly level and is selected
          more preferably from RefSeq than GenBank. If multiple genomes have the
          same high assembly level, the genome with the longest sequence is
        ...
        <p>
          ...
          three source databases (i.e., NCBI Virus, Virus-Host DB, and RefSeq).
        </p>
        ...
        <i>
          ...
          Front. Microbiol., July 2022. [doi:{" "}
          <a target="_blank" href="https://doi.org/10.3389/fmicb.2022.946070">
            10.3389/fmicb.2022.946070
          </a>
          ].
        </i>
      </div>
